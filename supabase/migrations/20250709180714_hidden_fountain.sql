/*
  # Add User Management Functions and Indexes

  1. New Functions
    - `get_user_subscription` - Efficiently retrieves user subscription data
    - `auto_verify_admin_emails` - Automatically verifies admin emails
    - `update_event_registration` - Properly tracks event registrations

  2. Indexes
    - Add index on users.id for better query performance
