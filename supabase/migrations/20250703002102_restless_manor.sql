/*
  ...
  1. Changes
    - Update user authentication settings to disable email verification
    - Modify existing users to mark all emails as verified
...
-- Disable email verification requirement in auth settings
UPDATE auth.config
