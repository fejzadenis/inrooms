...
CREATE OR REPLACE FUNCTION get_user_registrations(input_user_id TEXT)
RETURNS TABLE(
  id TEXT,
  user_id TEXT,
  event_id TEXT,
...
CREATE OR REPLACE FUNCTION get_event_registrations(input_event_id TEXT)
RETURNS TABLE(
  id TEXT,
  user_id TEXT,
  event_id TEXT,
