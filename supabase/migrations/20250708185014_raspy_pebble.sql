/*
  ...
  1. New Features
    ...
    - Create trigger function to mark users for Firebase sync when subscription data changes
    - Create trigger to automatically mark users for sync when relevant fields change
  ...
  3. Changes
    - Adds columns to track Firebase sync status
    - Creates trigger function to mark records for sync
    - Adds comment explaining the sync process
*/
